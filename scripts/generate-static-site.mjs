...
const data = {
  pt: {
    ...
    hero: [
      "Desenvolvedor web",
      "Eu crio sites profissionais para quem precisa aparecer melhor na internet.",
      ...
      "Quero um site",
      "Ver um projeto",
      "Me chame com sua ideia. Eu te ajudo a entender o melhor formato.",
    ],
  ...
  en: {
    ...
    hero: [
      ...
      "I need a website",
      "View a project",
      "Send me your idea. I can help you find the right format.",
    ],
