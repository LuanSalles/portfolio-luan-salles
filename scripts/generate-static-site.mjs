...
const home = shell({
  ...
  body: html`<main id="inicio">
    ...
    <section id="conteudo" class="hero wrap">
      ...
      <div class="hero-board" aria-label="Resumo do serviço"><div class="browser-card main-card"><span>vulan.com.br</span><strong>Sites pensados para negócios.</strong><p>Estrutura clara, versão mobile e contato direto pelo WhatsApp.</p></div><div class="hero-proof"><span>Mobile</span><span>WhatsApp</span><span>SEO básico</span></div></div>
    </section>
    ...
    <section id="projetos" class="section case-section"><div class="wrap case-showcase"><div class="case-heading"><div><p class="eyebrow">Case principal</p><h2>Alquimia do Bonsai</h2><p>Presença digital para uma marca dedicada a bonsais, conteúdo educativo e catálogo de produtos.</p></div><a class="btn btn-primary" href="${caseUrl}" target="_blank" rel="noreferrer">Visitar projeto</a></div><div class="case-layout"><div class="case-browser"><div class="browser-bar"><span>alquimiadobonsai.com</span></div><div class="case-preview"><img src="/alquimia-bonsai-1180.jpg" alt="Página inicial do site Alquimia do Bonsai no desktop" /></div><div class="case-strip"><span>Site publicado</span><span>Catálogo</span><span>Vídeos</span><span>WhatsApp</span></div><div class="case-fallback"><div><strong>Projeto no ar</strong><p>Abra o site real para navegar pela versão completa.</p></div><a class="btn btn-secondary" href="${caseUrl}" target="_blank" rel="noreferrer">Abrir site</a></div></div><div class="case-copy"><article><span>Necessidade</span><p>Criar uma presença digital profissional para apresentar a marca, divulgar bonsais disponíveis e publicar conteúdos sem depender de alterações no código.</p></article><article><span>Solução desenvolvida</span><p>A Vulan criou uma estrutura com presença institucional, catálogo, administração de conteúdo, vídeos, WhatsApp e interface responsiva.</p></article><article><span>Resultado</span><p>A marca passou a possuir um ambiente próprio para apresentar produtos e conteúdos, com autonomia para atualizar informações principais pelo painel administrativo.</p></article></div></div></div></section>
